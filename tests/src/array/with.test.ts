...
botest.assertJsArrayEquals(result7, [undefined, 'replaced', 0, false], "arr6.with(1, 'replaced') should return [undefined, 'replaced', 0, false]");
...
botest.assertJsArrayEquals(result9, [[1, 2], [99, 100], [5, 6]], "arr8.with(1, [99, 100]) should return [[1, 2], [99, 100], [5, 6]]");
botest.assertJsArrayEquals(arr8, [[1, 2], [3, 4], [5, 6]], "arr8 original should be unchanged"); // Original unchanged

// Mixed types array
const arr9: any[] = [1, "hello", true, null, undefined];
const result10 = arr9.with(2, false);
botest.assertJsArrayEquals(result10, [1, "hello", false, null, undefined], "arr9.with(2, false) should return [1, 'hello', false, null, undefined]");
