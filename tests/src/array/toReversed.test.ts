...
botest.assertJsArrayEquals(
  result1,
  [5, 4, 3, 2, 1],
  "arr1.toReversed() should return [5, 4, 3, 2, 1]",
);
...
botest.assertJsArrayEquals(
  result2,
  [4, 3, 2, 1],
  "arr2.toReversed() even length should return [4, 3, 2, 1]",
);
...
botest.assertJsArrayEquals(
  result3,
  [3, 2, 1],
  "arr3.toReversed() odd length should return [3, 2, 1]",
);
...
botest.assertJsArrayEquals(
  ...
  "arr5.toReversed() should return [false, 0, null, undefined]",
);
...
botest.assertJsArrayEquals(
  result9,
  [[], [2, 3], [1]],
  "arr7.toReversed() should return [[], [2, 3], [1]]",
);
botest.assertValueEquals(
  result9[1] === arr7[1],
  true,
  "result9[1] should be same reference as arr7[1]",
); // Same reference
...
botest.assertJsArrayEquals(
  result10,
  [true, undefined, null, "a", 1],
  "arr8.toReversed() should return [true, undefined, null, 'a', 1]",
);
botest.assertJsArrayEquals(
  arr8,
...
botest.assertJsArrayEquals(
  result11,
  ["d", "c", "b", "a"],
  "arr9.toReversed() should return ['d', 'c', 'b', 'a']",
);
...
botest.assertJsArrayEquals(
  result13,
  result14,
  "multiple toReversed() calls should return same result",
);
