...
botest.assertJsArrayEquals(entries1, [[0, 'a'], [1, 'b'], [2, 'c']], "entries() should return index-value pairs");
...
botest.assertJsArrayEquals(entries3, [[0, 1], [1, 'hello'], [2, true], [3, null], [4, undefined]], "entries() should work with mixed types");

// Array with nested arrays
const nestedArr = [[1, 2], ['a', 'b'], []];
const entries4 = nestedArr.entries();
botest.assertJsArrayEquals(entries4, [[0, [1, 2]], [1, ['a', 'b']], [2, []]], "entries() should work with nested arrays");
