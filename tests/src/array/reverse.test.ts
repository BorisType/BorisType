...
botest.assertJsArrayEquals(
  arr1,
  [5, 4, 3, 2, 1],
  "arr1.reverse() should reverse to [5, 4, 3, 2, 1]",
);
...
botest.assertJsArrayEquals(
  ...
  "arr5.reverse() with undefined/null should be [false, 0, null, undefined]",
);
...
botest.assertJsArrayEquals(
  arr7,
  [[], [2, 3], [1]],
  "arr7.reverse() nested arrays should be [[], [2, 3], [1]]",
);
...
botest.assertJsArrayEquals(
  ...
  "arr8.reverse() mixed types should be [true, undefined, null, 'a', 1]",
);
...
botest.assertJsArrayEquals(
  arr9,
  ["d", "c", "b", "a"],
  "arr9.reverse() strings should be ['d', 'c', 'b', 'a']",
);
...
botest.assertValueEquals(
  result === arr11,
  true,
  "arr11.reverse() should return the same array reference",
);
