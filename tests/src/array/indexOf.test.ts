...
botest.assertValueEquals(
  arr1.indexOf(2),
  1,
  "indexOf(2) should return first occurrence at index 1",
);
...
botest.assertValueEquals(
  arr1.indexOf(2, 2),
  4,
  "indexOf(2, 2) should find second occurrence at index 4",
);
botest.assertValueEquals(
  arr1.indexOf(2, 5),
  -1,
  "indexOf(2, 5) start beyond array should return -1",
);
...
botest.assertValueEquals(
  arr1.indexOf(2, -3),
  4,
  "indexOf(2, -3) should find occurrence at index 4",
);
botest.assertValueEquals(
  arr1.indexOf(1, -100),
  0,
  "indexOf(1, -100) large negative should search from start",
);
...
botest.assertValueEquals(
  arr2.indexOf("a", 1),
  3,
  "indexOf('a', 1) should skip first and return index 3",
);
...
botest.assertValueEquals(
  arr5.indexOf(obj),
  0,
  "indexOf(obj) should find same reference at index 0",
);
botest.assertValueEquals(
  arr5.indexOf({ x: 1 }),
  -1,
  "indexOf with different object ref should return -1",
);
...
botest.assertValueEquals(
  arr6.indexOf(subArr),
  0,
  "indexOf(subArr) should find same reference at index 0",
);
botest.assertValueEquals(
  arr6.indexOf([1, 2]),
  -1,
  "indexOf with different array ref should return -1",
);
...
botest.assertValueEquals(
  mixedArr.indexOf(undefined),
  4,
  "indexOf(undefined) should return index 4",
);
...
botest.assertValueEquals(
  nestedArr.indexOf(nestedArr[1]),
  1,
  "indexOf(nestedArr[1]) same ref should return 1",
);
