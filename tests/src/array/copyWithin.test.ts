...
botest.assertJsArrayEquals(
  arr1,
  [4, 5, 3, 4, 5],
  "copyWithin(0, 3) should copy from index 3 to start",
);
...
botest.assertJsArrayEquals(
  arr2,
  [1, 4, 3, 4, 5],
  "copyWithin(1, 3, 4) should copy single element to index 1",
);
...
botest.assertJsArrayEquals(
  arr3,
  [1, 2, 3, 1, 2],
  "copyWithin(-2, 0, 2) should copy to last two positions",
);
...
botest.assertJsArrayEquals(
  arr4,
  [4, 5, 3, 4, 5],
  "copyWithin(0, -2) should copy from last two elements",
);
...
botest.assertJsArrayEquals(
  arr5,
  [1, 2, 3],
  "copyWithin with out of bounds target should not change array",
);
...
botest.assertJsArrayEquals(
  ...
  "copyWithin should preserve undefined/null",
);
