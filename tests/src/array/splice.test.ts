...
botest.assertJsArrayEquals(
  removed6,
  [5, 6],
  "arr6.splice(2, 2, 3, 4) should return removed [5, 6]",
);
...
botest.assertJsArrayEquals(
  removed7,
  [],
  "arr7.splice(1, 0, 'a', 'b', 'c') should return empty array",
);
botest.assertJsArrayEquals(
  arr7,
  [1, "a", "b", "c", 2],
  "arr7 after adding should be [1, 'a', 'b', 'c', 2]",
);
...
botest.assertJsArrayEquals(
  removed10,
  [],
  "arr10.splice(5, 1) out of bounds should return empty array",
);
...
botest.assertJsArrayEquals(
  removed11,
  [1, 2],
  "arr11.splice(-10, 2) large negative should return [1, 2]",
);
...
botest.assertJsArrayEquals(
  removed15,
  [],
  "singleArr2.splice(0, 0, 'before') should return empty array",
);
botest.assertJsArrayEquals(
  singleArr2,
  ["before", 42],
  "singleArr2 after adding should be ['before', 42]",
);
...
botest.assertJsArrayEquals(
  removed16,
  [null, 0],
  "arr13.splice(1, 2, 'a', 'b') should return removed [null, 0]",
);
botest.assertJsArrayEquals(
  arr13,
  [undefined, "a", "b", false],
  "arr13 after splice should be [undefined, 'a', 'b', false]",
);
...
botest.assertJsArrayEquals(
  removed17,
  [obj1],
  "arr14.splice(0, 1, {z:3}) should return removed [obj1]",
);
...
botest.assertJsArrayEquals(
  removed18,
  [[2, 3]],
  "arr15.splice(1, 1, ['new']) should return removed [[2, 3]]",
);
botest.assertJsArrayEquals(
  arr15,
  [[1], ["new"], []],
  "arr15 after splice should be [[1], ['new'], []]",
);
...
botest.assertJsArrayEquals(
  removed19,
  [null, undefined],
  "arr16.splice(2, 2, 42, 'hello') should return removed [null, undefined]",
);
botest.assertJsArrayEquals(
  arr16,
  [1, "a", 42, "hello", true],
  "arr16 after splice should be [1, 'a', 42, 'hello', true]",
);
...
botest.assertJsArrayEquals(
  removed20,
  [2, 3, 4],
  "arr17.splice(1, 3) should return removed [2, 3, 4]",
);
