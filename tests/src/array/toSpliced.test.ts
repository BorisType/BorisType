...
botest.assertJsArrayEquals(
  result5,
  [1, 2, 3, 4, 5],
  "arr5.toSpliced(2, 0, 3) should return [1, 2, 3, 4, 5]",
);
...
botest.assertJsArrayEquals(
  result6,
  [1, 2, 3, 4],
  "arr6.toSpliced(2, 2, 3, 4) should return [1, 2, 3, 4]",
);
...
botest.assertJsArrayEquals(
  result7,
  [1, "a", "b", "c", 2],
  "arr7.toSpliced(1, 0, 'a', 'b', 'c') should return [1, 'a', 'b', 'c', 2]",
);
...
botest.assertJsArrayEquals(
  result8,
  [1, 2, 3, 5],
  "arr8.toSpliced(-2, 1) should return [1, 2, 3, 5]",
);
...
botest.assertJsArrayEquals(
  result9,
  [1, 2, 3, 4, 5],
  "arr9.toSpliced(-1, 0, 4) should return [1, 2, 3, 4, 5]",
);
...
botest.assertJsArrayEquals(
  result10,
  [1, 2, 3],
  "arr10.toSpliced(5, 1) out of bounds should return [1, 2, 3]",
);
...
botest.assertJsArrayEquals(
  result11,
  [3],
  "arr11.toSpliced(-10, 2) large negative should return [3]",
);
...
botest.assertJsArrayEquals(
  result15,
  ["before", 42],
  "singleArr2.toSpliced(0, 0, 'before') should return ['before', 42]",
);
...
botest.assertJsArrayEquals(
  ...
  "arr13 original should be unchanged",
); // Original unchanged
...
botest.assertJsArrayEquals(
  result17,
  [{ z: 3 }, obj2],
  "arr14.toSpliced(0, 1, {z:3}) should return [{z:3}, obj2]",
);
botest.assertValueEquals(
  result17[1] === obj2,
  true,
  "result17[1] should be same reference as obj2",
); // Same reference
...
botest.assertJsArrayEquals(
  result18,
  [[1], ["new"], []],
  "arr15.toSpliced(1, 1, ['new']) should return [[1], ['new'], []]",
);
botest.assertValueEquals(
  result18[0] === arr15[0],
  true,
  "result18[0] should be same reference as arr15[0]",
); // Same reference
...
botest.assertJsArrayEquals(
  ...
  "arr16 original should be unchanged",
); // Original unchanged
