...
botest.assertJsArrayEquals(result16, [undefined, 'a', 'b', false], "arr13.toSpliced(1, 2, 'a', 'b') should return [undefined, 'a', 'b', false]");
...
botest.assertJsArrayEquals(result19, [1, "a", 42, "hello", true], "arr16.toSpliced(2, 2, 42, 'hello') should return [1, 'a', 42, 'hello', true]");
