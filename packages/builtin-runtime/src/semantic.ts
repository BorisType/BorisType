export namespace bt {
    ...
    export function getProperty(object: any, propertyName: string | number) {
        ...
        if (dataType === 'object') {
            ...
            if (returnValue === undefined) {
                ...
                if (objectTypeOfObject === "DxTrans") {
                    var knownObjectMethods = ["AddRespHeader", "CheckLdsAuth", "Execute", "GetSessionByID", "HandleNotFound", "PermanentRedirect", "Redirect", "SetRespStatus", "SetWrongAuth", "UpgradeToWebSocket"];
                    if (ArrayOptFind(knownObjectMethods, "This === propertyName") !== undefined) {
                        return {
                            "@descriptor": "function",
                            "obj": object,
        ...
        if (dataType === 'string') {
            ...
            var knownObjectMethods = ["Allocate", "charAt", "charCodeAt", "fromCharCode", "indexOf", "lastIndexOf", "slice", "split", "substr", "toLowerCase", "ToWinLineBreaks"];
            if (ArrayOptFind(knownObjectMethods, "This === propertyName") !== undefined) {
                return {
                    "@descriptor": "function",
                    "obj": object,
