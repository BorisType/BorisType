...
export async function runTestsAsync(filePath: string, cwdPath: string, filters: string[] = []): Promise<void> {
    ...
    printTestReport(suites.map(suite => suite.name), startTime, testResults);
...
async function loadTestEnv() {
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/polyfill.js");`);
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/semantic.js");`);
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/destructuring.js");`);
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/require.js");`);
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/cache.js");`);
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-runtime/build/filemap.js");`);
    ...
    await evalBorisScriptAsync(`RegisterCodeLibrary("x-local://packages/builtin-botest/build/index.js");`);
