...
**Что:** Объявления функций создают env, desc и регистрируются в __env
...
// После
function greet(__env, __this, __args) { alert("Hi"); }
// ... env/desc setup ...
...
| 2026-02-09 | Функции создают env/desc и регистрируются в __env |
...
| 2026-02-08 | Реализовано чтение captured через __env.varName |
| 2026-02-08 | Добавлена CLI опция --debug-scopes |
| 2026-02-08 | Создание __env объекта в module/function scope |
